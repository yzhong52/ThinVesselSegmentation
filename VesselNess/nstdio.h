...
inline long long fwrite_big( const void* _Str, size_t _Size, long long _Count, FILE* _File );
inline long long fread_big( void* _DstBuf, size_t _ElementSize, long long _Count, FILE* _File ); 
